...
output:
  html_document: 
    css: "C:/Users/gregl/OneDrive/Documents/UCC-Dashboard/UCC_Style.css"
    highlight: tango
---
...
sinai_colors <- c("#221F72", "#00AEEF", "#D80B8C", "#B2B3B2", "#C7C6EF","#DDDEDD","#FCC9E9","#C00000","#009242")
...
library(knitr)
library(kableExtra)
colnames(Compliance_FYTD) <- c("Location","Total","N","% of Tot.","NA","% of Tot.","NA","% of Tot.","NA","% of Tot.")
